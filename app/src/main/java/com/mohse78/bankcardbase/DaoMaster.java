...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        AccountTransactionDao.createTable(db, ifNotExists);
        SmsBankMetaDataDao.createTable(db, ifNotExists);
        TransactionTypeDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        AccountTransactionDao.dropTable(db, ifExists);
        SmsBankMetaDataDao.dropTable(db, ifExists);
        TransactionTypeDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(AccountTransactionDao.class);
        registerDaoClass(SmsBankMetaDataDao.class);
        registerDaoClass(TransactionTypeDao.class);
    }
